...
$hook = array(
    'hook' => 'ClientAreaPageDomainRegisterNameservers',
    'function' => 'ClientAreaPageDomainRegisterNameservers',
    'type' => 'client',
);

if (!function_exists('ClientAreaPageDomainRegisterNameservers')) {
    function ClientAreaPageDomainRegisterNameservers($args){
