...
$hook = array(
    'hook' => 'OverrideOrderNumberGeneration',
    'function' => 'OverrideOrderNumberGeneration',
    'type' => 'client',
);
if (!function_exists('OverrideOrderNumberGeneration')) {
    function OverrideOrderNumberGeneration($args){
        $class = new SMSIR();
		...
		$type = 'order';
		if($apiparamsarray['registerwithverification'] == "on"){
