...
$hook = array(
    'hook' => 'ClientAreaProductDetails',
    'function' => 'ClientAreaProductDetails',
    'type' => 'client',
);

if (!function_exists('ClientAreaProductDetails')) {
    function ClientAreaProductDetails($args){
		...
		$type = 'clientareaproduct';
		if($apiparamsarray['clientareaproductwithverification'] == "on"){
