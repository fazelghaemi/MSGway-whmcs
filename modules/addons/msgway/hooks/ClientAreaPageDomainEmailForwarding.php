...
$hook = array(
    'hook' => 'ClientAreaPageDomainEmailForwarding',
    'function' => 'ClientAreaPageDomainEmailForwarding',
    'type' => 'client',
);

if (!function_exists('ClientAreaPageDomainEmailForwarding')) {
    function ClientAreaPageDomainEmailForwarding($args){
