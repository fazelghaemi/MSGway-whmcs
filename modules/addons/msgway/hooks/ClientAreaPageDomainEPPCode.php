...
$hook = array(
    'hook' => 'ClientAreaPageDomainEPPCode',
    'function' => 'ClientAreaPageDomainEPPCode',
    'type' => 'client',
);

if (!function_exists('ClientAreaPageDomainEPPCode')) {
    function ClientAreaPageDomainEPPCode($args){
