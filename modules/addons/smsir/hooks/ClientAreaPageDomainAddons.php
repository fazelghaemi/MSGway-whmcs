...
$hook = array(
    'hook' => 'ClientAreaPageDomainAddons',
    'function' => 'ClientAreaPageDomainAddons',
    'type' => 'client',
);

if (!function_exists('ClientAreaPageDomainAddons')) {
    function ClientAreaPageDomainAddons($args){
