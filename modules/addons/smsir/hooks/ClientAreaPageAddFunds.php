...
$hook = array(
    'hook' => 'ClientAreaPageAddFunds',
    'function' => 'ClientAreaPageAddFunds',
    'type' => 'client',
);

if (!function_exists('ClientAreaPageAddFunds')) {
    function ClientAreaPageAddFunds($args){
		...
		$type = 'clientareaaddfunds';
		if($apiparamsarray['clientareaaddfundwithverification'] == "on"){
