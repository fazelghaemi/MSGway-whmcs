...
$hook = array(
    'hook' => 'ClientAreaPageViewInvoice',
    'function' => 'ClientAreaPageViewInvoice',
    'type' => 'client',
);

if (!function_exists('ClientAreaPageViewInvoice')) {
    function ClientAreaPageViewInvoice($args){
		...
		$type = 'clientareainvoice';
		if($apiparamsarray['clientareainvoicewithverification'] == "on"){
