...
$hook = array(
    'hook' => 'ClientAreaPageDomainContacts',
    'function' => 'ClientAreaPageDomainContacts',
    'type' => 'client',
);

if (!function_exists('ClientAreaPageDomainContacts')) {
    function ClientAreaPageDomainContacts($args){
