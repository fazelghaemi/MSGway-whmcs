...
$hook = array(
    'hook' => 'ClientAreaPageViewEmail',
    'function' => 'ClientAreaPageViewEmail',
    'type' => 'client',
);

if (!function_exists('ClientAreaPageViewEmail')) {
    function ClientAreaPageViewEmail($args){
		...
		$type = 'clientareaemail';
		if($apiparamsarray['clientareaemailwithverification'] == "on"){
